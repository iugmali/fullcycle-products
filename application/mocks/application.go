...
import (
	...
	application "github.com/iugmali/fullcycle-products/application"
...
func (m *MockProductInterface) SetPrice(price int64) error {
	m.ctrl.T.Helper()
...
func (mr *MockProductInterfaceMockRecorder) SetPrice(price any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SetPrice mocks base method.
func (m *MockProductServiceInterface) SetPrice(product application.ProductInterface, price int64) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetPrice", product, price)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// SetPrice indicates an expected call of SetPrice.
func (mr *MockProductServiceInterfaceMockRecorder) SetPrice(product, price any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetPrice", reflect.TypeOf((*MockProductServiceInterface)(nil).SetPrice), product, price)
}
...
// Get indicates an expected call of Get.
func (mr *MockProductReaderInterfaceMockRecorder) Get(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProductWriterInterfaceMockRecorder) Save(product any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
